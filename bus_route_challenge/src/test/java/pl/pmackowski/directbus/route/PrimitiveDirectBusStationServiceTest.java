...
public class PrimitiveDirectBusStationServiceTest {

    private DirectBusStationService directBusStationService = new PrimitiveDirectBusStationService();
    @Mock
    ...
    public void shouldCheckDirectRoute(BusRouteTestCase testCase) {
        ...
        directBusStationService.addBusRoute(busRoute1);
        directBusStationService.addBusRoute(busRoute2);
        directBusStationService.addBusRoute(busRoute3);
